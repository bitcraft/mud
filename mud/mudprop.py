...
class PermissionHandler(object):
    ...
    def get_permission(self, caller):
        """
        we have to be careful not to directly access any of our own data to avoid a recursive loop of calls
        to __getattribute__
        """
        ...
        try:
            ...
            # we need a copy of group (not ref) here to avoid recursive calls to check permission
            group = []
